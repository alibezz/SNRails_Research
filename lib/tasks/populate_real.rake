  ...
  namespace :populate do
    ...
    task :real => :environment  do
      ...
      questions = [
                   ...
                   ["Question", "Quais destas TIC você tem em casa?", 1, "checkbox", ["TV", "Computador", "Notebook", "Videogame", "TV a Cabo", "Internet Banda Larga", "Celular", "Nenhum anterior", "Outros:"]],
      ...
      questions.each do |q|
        ...
        if q[0].downcase == "question"
          ...
          if q[3] != "pure_text"
            q[4].each do |iv|
              ItemValue.create(:item_id => item.id, :position => p, :info => iv)
              p += 1
            end
          end
          if q[5].nil?
